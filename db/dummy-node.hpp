...
public:
   ...
   inline node_id get_id(void) const {}
   inline node_id get_translated_id(void) const {}

   inline void set_owner(sched::base *_owner) {}
   inline sched::base *get_owner(void) const {}
